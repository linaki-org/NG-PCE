...
To maximize its effectiveness in educational settings, PyCAPGE is supported by a comprehensive, bilingual instructional manual (English/Spanish) and an extended academic paper archived on Zenodo. This documentation functions as a structured curriculum that guides students through the entire development lifecycle, from environmental setup and file architecture to the implementation of specific Object-Oriented Programming (OOP) concepts.

The manual and the accompanying 5-scene demo serve as a practical laboratory for analyzing core engine functions—such as bitmask-based navigation, pathfinding heuristics, and multi-layer parallax scrolling—through clear visual breakdowns. A key pedagogical feature is the integrated real-time debug system (accessible via F3/F4), which allows learners to visualize walkboxes and monitor player states, bridging the gap between abstract code and functional execution. By exposing the mechanics of classic 1990s adventure games through a readable Python codebase, PyCAPGE provides instructors with a "glass box" scaffolding tool for teaching event-driven design, finite-state machines, and resource management, effectively bridging the gap between basic scripting and industrial engine complexity.
