...
To maximize its effectiveness in educational settings, PyCAPGE is supported by a comprehensive, bilingual instructional manual available in both English and Spanish. This documentation functions as a structured curriculum that guides students through the entire development lifecycle, from environmental setup and file architecture to the implementation of specific Object-Oriented Programming (OOP) concepts. 

The manual and the extended academic paper (archived on Zenodo) provide a step-by-step analysis of the engine's core functions, accompanied by a fully functional 5-scene demo that serves as a practical laboratory. By providing clear visual breakdowns of complex mechanics—such as bitmask-based navigation, pathfinding heuristics, and multi-layer parallax scrolling—the resources equip instructors with a "glass box" scaffolding tool. This approach enables students to explore event-driven design, finite-state machines, and resource management through a readable, hands-on codebase, bridging the gap between basic scripting and industrial engine complexity.
