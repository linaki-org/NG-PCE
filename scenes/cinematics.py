...
class CinematicManager:
    def __init__(self, set_state_callback, play_music_callback, get_texts_callback, scene_manager_ref=None):
        self.slides = []
    ...
    def start_cinematic(self, cinematic):
        cine_texts = self.get_texts()

        self.playlist = cinematic
